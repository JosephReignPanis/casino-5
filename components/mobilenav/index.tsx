  ...
  return (
    <>
      <div className="block lg:hidden">
        ...
        {/* Left Sidebar */}
        <div
          className={`fixed top-0 left-0 h-full w-full bg-neutral-900 text-white transform p-2 ${
        ...
        {/* Right Sidebar */}
        <div
          className={`fixed top-0 right-0 h-full w-full bg-zinc-900 text-white transform p-2 ${
            isRightOpen ? "translate-x-0" : "translate-x-full"
          } transition-transform duration-300 ease-in-out shadow-lg z-30 overflow-y-auto`}
        >
          <div className="flex justify-end bg-neutral-900 p-2">
            <i
              className="fa-solid fa-xmark cursor-pointer text-lg"
